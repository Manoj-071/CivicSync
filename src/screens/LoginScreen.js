  ...
  return (
    <LinearGradient colors={colors.bgGradient} style={globalStyles.container}>
      <View style={globalStyles.glassCard}>
        ...
        <Text style={styles.subtitle}>Sign in to report or resolve local concerns</Text>
        ...
        <TouchableOpacity style={[globalStyles.primaryButton, styles.googleBtn]}>
          <Text style={globalStyles.buttonText}>🌐 Continue with Google</Text>
        </TouchableOpacity>
      </View>

      <TouchableOpacity onPress={() => setIsRegistering(true)}>
        <Text style={styles.footerText}>Don't have a regular account? <Text style={{color: colors.accent}}>Create Account</Text></Text>
      </TouchableOpacity>
    </LinearGradient>
  );
}
